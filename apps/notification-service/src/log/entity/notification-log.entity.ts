...
@Index('idx_notification_logs_status_created_at', ['status', 'createdAt'])
@Index('idx_notification_logs_channel_created_at', ['channel', 'createdAt'])
@Entity({
